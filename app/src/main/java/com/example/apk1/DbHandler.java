...
public class DbHandler extends SQLiteOpenHelper {
    ...
    void insertUserDetails(String name, String designation, String location) {
        ...
        cValues.put(KEY_DESIGNATION, designation);
    ...
    public ArrayList<HashMap<String, String>> GetUsers() {
        ...
        String query = "SELECT name, designation, location, id FROM " + TABLE_Users;
        Cursor cursor = db.rawQuery(query, null);
        while (cursor.moveToNext()) {
            HashMap<String, String> user = new HashMap<>();
            user.put("name", cursor.getString(cursor.getColumnIndex(KEY_NAME)));
            user.put("designation", cursor.getString(cursor.getColumnIndex(KEY_DESIGNATION)));
    ...
    public ArrayList<HashMap<String, String>> GetUserByUserId(int userid) {
        ...
        Cursor cursor = db.query(TABLE_Users, new String[]{KEY_NAME, KEY_DESIGNATION, KEY_LOCATION},
    ...
    // Update User Details
    public int UpdateUserDetails(String name, String designation, String location, int id) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cVals = new ContentValues();
        cVals.put(KEY_NAME, name);
        cVals.put(KEY_DESIGNATION, designation);
